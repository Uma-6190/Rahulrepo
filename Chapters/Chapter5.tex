...
The different initialisation schemes will be referred to as: Random: randomly initialised weights, Exp1: the weights trained during experiment 1, Exp2: the weights trained during experiment 2, Exp 3: the weights trained during experiment 3 starting from random initialisation. Two other conditions, Random 80 and Random 100 utilise a random initialisations but have 80 and 100 samples per object respectively compared to the 50 samples per object used in all other conditions.
...
\centering
	...
	\hline
	Initialisation & 	Bimodal & 	Image Only 	& 	Words Only \\ \hline
Random (100 ep)	&	3.82	$\mypm$	0.30	&	54.12	$\mypm$	43.74	&	3.96	$\mypm$	0.22	\\ \hline
Random (50 ep)	&	3.66	$\mypm$	0.06	&	5.18	$\mypm$	2.39	&	3.89	$\mypm$	0.07	\\ \hline
Random 80 (100ep) &		3.45	$\mypm$ 0.20	&	6.54	$\mypm$	5.30	&	3.78	$\mypm$	0.61\\ \hline
Random 80 (50ep)	&	3.54	$\mypm$	0.11	&	3.91	$\mypm$	1.17	&	3.86	$\mypm$	0.12	\\ \hline

Random 100 (100ep) &	3.78	$\mypm$	0.21	&	5.37	$\mypm$	2.52	&	4.02	$\mypm$	0.27	\\ \hline
...
\begin{figure}[h]
\centering
\includegraphics[width=0.625\textwidth]{Figs/shapes/singlelabel739_shape.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.625\textwidth]{Figs/shapes/singlelabel739_col.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.625\textwidth]{Figs/shapes/singlelabel739_pos.png}
...
\centering
	...
	\hline
	Initialisation & 	Bimodal & 	Image Only 	& 	Words Only \\ \hline
Random (100ep)	&	100.00	$\mypm$	0.00	&	96.10	$\mypm$	6.29	&	100.00	$\mypm$	0.00	\\ \hline
Random (50 ep) &	100.00	$\mypm$	0.00	&	97.44	$\mypm$	5.77	&	100.00	$\mypm$	0.00	\\ \hline
Random 80 & 100.00	$\mypm$	0.00	&	99.67	$\mypm$	1.07	&	100.00	$\mypm$	0.00	\\ \hline
Random 80 (50ep)	&	100.00	$\mypm$	0.00	&	99.94	$\mypm$	0.27	&	100.00	$\mypm$	0.00	\\ \hline

Random 100	&	100.00	$\mypm$	0.00	&	99.84	$\mypm$	0.38	&	100.00	$\mypm$	0.00	\\ \hline
...
\todo[inline]{relate change in performance to bidirectional grounding}
...
I will examine the omission of 3 different objects, these trials will be referred to as MAE 1: omission of green triangles'', MAE 2: omisssion of orange rectangles'' and MAE 3: omission of  violet circles''. Each MAE is initialised with random weights.
...
MAE 2	&	4.09	$\mypm$	0.45	&	101.18	$\mypm$	87.19	&	4.10	$\mypm$	0.27	\\ \hline
MAE 2*	&	7.40	$\mypm$	0.77	&	138.82	$\mypm$	83.42	&	4.80	$\mypm$	0.33	\\ \hline
MAE 3	&	3.84	$\mypm$	0.18	&	7.15	$\mypm$	4.96	&	4.06	$\mypm$	0.18	\\ \hline
MAE 3*	&	8.41	$\mypm$	11.91	&	36.00	$\mypm$	26.03	&	2.82	$\mypm$	0.52	\\ \hline
...
\paragraph{Image Generation}
To further demonstrate the abilities of multimodal representation learning through the use of a MAE, I used three subsets of data to train three MAEs. Each of the MAEs was trained 4 times for validation purposes as with all other experiments.
...
\todo[inline]{vector arithmetic results}
...
\centering
	...
	\hline
Trial	 & 	Bimodal & 	Image Only 	& 	Words Only \\ \hline
MAE 1	&	100.00	$\mypm$	0.0	&	99.91	$\mypm$	0.19	&	100.00	$\mypm$	0.00	\\ \hline
MAE 1*	&	98.41	$\mypm$	10.12	&	95.72	$\mypm$	12.93	&	98.72	$\mypm$	9.48	\\ \hline
MAE 2	&	100.00	$\mypm$	0.00	&	92.74	$\mypm$	11.02	&	100.00	$\mypm$	0.00	\\ \hline
MAE 2*	&	99.67	$\mypm$	1.18	&	89.18	$\mypm$	20.72	&	100.00	$\mypm$	0.00	\\ \hline
MAE 3	&	100.00	$\mypm$	0.00	&	99.66	$\mypm$	0.68	&	100.00	$\mypm$	0.00	\\ \hline
MAE 3*	&	99.37	$\mypm$	4.17	&	96.59	$\mypm$	8.68	&	99.97	$\mypm$	0.27	\\ \hline
	\end{tabular}
...
Seeing that both accurate descriptions and reconstructed images can be generated by the MAE for unseen objects, we can conclude that the MAE is capable of bidirectional symbol grounding.
...
\todo[inline]{pribably move a lot of this explanation to the background chapter}
