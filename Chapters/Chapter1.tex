...
\begin{figure}[h]
\centering
	\includegraphics[width=0.3\textwidth]{Figs/introduction/stirling.png}
...
[node distance=1.5cm,
  ...
  \node (A)        [activityStarts, below of=object, yshift=-0.7cm]          {\includegraphics[width=1.5cm,height=1.5cm]{Figs/introduction/stirling.png}};
