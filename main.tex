...
{\large \today}\\[1cm] % Date
%\includegraphics[width=4cm]{./Figs/logos/HWUlogo.jpg}
%\hspace{1cm} % University/department logo - uncomment to place it
\includegraphics[width=5cm]{./Figs/logos/ecr.pdf}
%\hspace{1cm}
%\includegraphics[width=4cm]{./Figs/logos/uoe.eps}
\vfill
\end{center}
...
\textbf{MRL} & \textbf{M}ultimodal \textbf{R}epresentation \textbf{L}earning \textbf{Net}work \\
\textbf{ConvNet} & \textbf{Conv}olutional neural \textbf{Net}work \\
